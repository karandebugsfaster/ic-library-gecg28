...
export default function ManagerDashboard() {
  ...
  // Add this function inside ManagerDashboard component
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Rest of the dashboard code - SAME AS ADMIN DASHBOARD */}
      {/* Copy everything from the admin dashboard page.js */}
      {/* Stats cards, tabs, tables, etc. */}
    </div>
  );
}
