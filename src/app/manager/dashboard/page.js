    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl text-center max-w-md">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">Failed to Load Dashboard</h2>
          <p className="text-slate-600 mb-4 text-sm sm:text-base">Unable to fetch dashboard data</p>
          <button
            onClick={fetchStats}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          ...
          <div className="hidden lg:flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1">IC Library Management System</p>
            </div>
            ...
            <div className="flex gap-4" style={{ width: 'max-content' }}>
              {[
                ...
                },
                {
                  ...
                  sub1: stats.pendingRequests > 0 ? 'Requires Approval' : 'All Clear',
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      ...
                      <div className={`${card.textColor} text-xs font-medium mt-1`}>{card.label}</div>
                    </div>
                  </div>
                  <div className={`flex justify-between text-xs pt-3 border-t ${card.border}`}>
                    <span className={card.textColor}>{card.sub1}</span>
                    {card.sub2 && <span className={card.textColor}>{card.sub2}</span>}
                  </div>
                  {card.onClick && (
                    <div className={`text-xs ${card.textColor} mt-2 font-medium`}>Tap to view →</div>
                  )}
                </motion.div>
              ))}
            </div>
          ...
          <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-purple-200 text-sm font-medium mt-1">Total Books</div>
                </div>
              </div>
              <div className="flex justify-between text-sm pt-4 border-t border-purple-500">
                <span className="text-purple-200">{stats.books.available} Available</span>
                <span className="text-purple-200">{stats.books.rented} Rented</span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-pink-200 text-sm font-medium mt-1">Total Students</div>
                </div>
              </div>
              <div className="flex justify-between text-sm pt-4 border-t border-pink-500">
                <span className="text-pink-200">{stats.users.active} Active</span>
                <span className="text-pink-200">{stats.users.blocked} Blocked</span>
              </div>
              <div className="text-xs text-pink-100 mt-2 font-medium">Click to manage →</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="text-5xl">👔</div>
                <div className="text-right">
                  <div className="text-4xl font-bold">{stats.faculties?.total || 0}</div>
                  <div className="text-indigo-200 text-sm font-medium mt-1">Total Faculties</div>
                </div>
              </div>
              <div className="flex justify-between text-sm pt-4 border-t border-indigo-500">
                <span className="text-indigo-200">{stats.faculties?.active || 0} Active</span>
                <span className="text-indigo-200">{stats.faculties?.pending || 0} Requests</span>
              </div>
              <div className="text-xs text-indigo-100 mt-2 font-medium">Click to manage →</div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="text-5xl">📖</div>
                <div className="text-right">
                  <div className="text-4xl font-bold">{stats.rentals.active}</div>
                  <div className="text-cyan-200 text-sm font-medium mt-1">Active Rentals</div>
                </div>
              </div>
              <div className="flex justify-between text-sm pt-4 border-t border-cyan-500">
                <span className="text-cyan-200">{stats.rentals.today} Today</span>
                <span className="text-cyan-200">{stats.rentals.total} Total</span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-4xl font-bold">{stats.rentals.overdue}</div>
                  <div className="text-orange-200 text-sm font-medium mt-1">Overdue Books</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-amber-200 text-sm font-medium mt-1">Pending Requests</div>
                </div>
              </div>
              <div className="text-sm pt-4 border-t border-amber-500">
                <span className="text-amber-200">
                  {stats.pendingRequests > 0 ? 'Requires Approval' : 'All Clear'}
                </span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="text-5xl">⏰</div>
                <div className="text-right">
                  <div className="text-4xl font-bold">{dueSoonRentals?.length || 0}</div>
                  <div className="text-yellow-200 text-sm font-medium mt-1">Due Tomorrow</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="text-5xl">📋</div>
                <div className="text-right">
                  <div className="text-4xl font-bold">{rentalHistory?.length || 0}</div>
                  <div className="text-slate-200 text-sm font-medium mt-1">All Records</div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-2 mb-6 overflow-x-auto">
          <div className="flex gap-2 min-w-max">
            {[
              ...
              { id: 'requests', label: 'Requests', count: stats.pendingRequests || 0, icon: '🔔' },
              { id: 'today', label: 'Today', count: todayRentals.length, icon: '📅' },
              { id: 'active', label: 'Rented', count: currentlyRented.length, icon: '📖' },
              { id: 'duesoon', label: 'Due Soon', count: dueSoonRentals?.length || 0, icon: '⏰' },
              { id: 'overdue', label: 'Overdue', count: overdueRentals.length, icon: '⚠️' },
                ...
                {tab.count !== undefined && (
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-bold ${
                      activeView === tab.id ? 'bg-white text-blue-600' : 'bg-blue-100 text-blue-600'
                    }`}
                  >
                    {tab.count}
                  </span>
        ...
        <AnimatePresence mode="wait">
          ...
          {activeView === 'overview' && (
            ...
            >
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">Quick Stats</h2>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 sm:p-4">
                    <div className="text-xs sm:text-sm text-slate-600 mb-1">Total Rentals</div>
                    <div className="text-2xl sm:text-3xl font-bold text-blue-600">{stats.rentals.total}</div>
                  </div>
                  <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3 sm:p-4">
                    <div className="text-xs sm:text-sm text-slate-600 mb-1">Available</div>
                    <div className="text-2xl sm:text-3xl font-bold text-green-600">{stats.books.available}</div>
                  </div>
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-3 sm:p-4">
                    <div className="text-xs sm:text-sm text-slate-600 mb-1">Students</div>
                    <div className="text-2xl sm:text-3xl font-bold text-purple-600">{stats.users.active}</div>
                  </div>
                  <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-3 sm:p-4">
                    <div className="text-xs sm:text-sm text-slate-600 mb-1">Due Tomorrow</div>
                    <div className="text-2xl sm:text-3xl font-bold text-amber-600">{dueSoonRentals?.length || 0}</div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-4 sm:p-6">
                  ...
                  <div className="space-y-2">
                    {overdueRentals.slice(0, 5).map((rental) => {
                      ...
                      return (
                        <div key={rental._id} className="bg-white rounded-lg p-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                          <div className="flex-1">
                            <div className="font-semibold text-slate-900 text-sm sm:text-base">{rental.bookSnapshot.title}</div>
                            <div className="text-xs sm:text-sm text-slate-600">{rental.userSnapshot.enrollmentNumber}</div>
                          </div>
          ...
          {activeView === 'requests' && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20 }}
            >
              <PendingRequestsSection managerId={session?.user?.id} onUpdate={fetchStats} />
            </motion.div>
          )}

          {/* For tables on mobile, add overflow-x-auto wrapper */}
          {/* Today's Rentals, Currently Rented, etc. - wrap tables with overflow-x-auto */}
          {/* I'll show one example, apply the same pattern to all table views */}
          ...
          {activeView === 'today' && (
            ...
            >
              <div className="p-4 sm:p-6 border-b border-slate-200">
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Books Rented Today</h2>
              </div>
              
              {todayRentals.length === 0 ? (
                <div className="p-8 sm:p-12 text-center">
                  <div className="text-4xl sm:text-6xl mb-4">📅</div>
                  <p className="text-slate-600 text-base sm:text-lg">No rentals today</p>
                </div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[640px]">
                    <thead className="bg-slate-50">
                      <tr>
                        <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Time</th>
                        <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Book</th>
                        <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Student</th>
                        <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Email</th>
                        <th className="px-4 sm:px-6 py-3 sm:py-4 text-left text-xs sm:text-sm font-semibold text-slate-900">Due Date</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200">
                      {todayRentals.map((rental) => (
                        <tr key={rental._id} className="hover:bg-slate-50 transition-colors">
                          ...
                          <td className="px-4 sm:px-6 py-3 sm:py-4">
                            <div className="font-semibold text-slate-900 text-xs sm:text-sm">{rental.bookSnapshot.title}</div>
                            <div className="text-xs text-slate-500">{rental.bookSnapshot.author}</div>
                          </td>
                          <td className="px-4 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-slate-900">{rental.userSnapshot.enrollmentNumber}</td>
                          <td className="px-4 sm:px-6 py-3 sm:py-4 text-xs sm:text-sm text-slate-600">{rental.userSnapshot.email}</td>
          ...
          {/* Apply the same responsive pattern to all other table views: active, duesoon, overdue, history */}
          {/* I'll leave the rest of your content sections as they are - just wrap tables with overflow-x-auto and add min-w-[640px] to tables */}
        </AnimatePresence>
      </div>
